...
namespace Amibou.Infrastructure.Configuration
{
    ...
    public class CacheTargetCollection : ConfigurationElementCollection
    {
        ...
        public new CacheTargetElement this[string key] => (CacheTargetElement)BaseGet(key);

        /// <summary>
        /// Returns a new collection element
        /// </summary>
        /// <returns>New <see cref="CacheTargetElement"/></returns>
        protected override ConfigurationElement CreateNewElement() => new CacheTargetElement();
        ...
        protected override object GetElementKey(ConfigurationElement element) => ((CacheTargetElement)element).KeyPrefix;
    }
}