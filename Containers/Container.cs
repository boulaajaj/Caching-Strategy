    ...
    public static class Container
    {
        ...
        public static T Get<T>()
        {
            ...
            catch (ResolutionFailedException ex)
            {
                ...
                //Log.Warn(
                    //"Amibou.Infrastructure.Containers.Container.Get<>() - resolution failed for type: {0}, message: {1}",
        ...
        public static IEnumerable<T> GetAll<T>() where T : class
        {
            ...
            if (typeof(T) == typeof(ICache) 
                || typeof(T) == typeof(ISerializer))//need to clean this later
                return implementations;

            implementation = Get<T>();
        ...
        public static void Register<T>(Lifetime lifetime)
        {
            if (!_unityContainer.IsRegistered<T>())
            {
                ...
                _unityContainer.Configure<unity.InterceptionExtension.Interception>()
