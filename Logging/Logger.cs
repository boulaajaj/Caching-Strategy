...
{
    /// <summary>
    /// Log class wrapping log4net ILog
    /// </summary>
    public class Logger
    {
        ...
        {
            WriteLog(LogLevel.Error, () => (message.FormatWith(args) + "{0}{1}".FormatWith(Environment.NewLine, ex)));
        }
        ...
        {
            WriteLog(level, () => message.FormatWith(args));
        }
